var Game = (function () {
    ...
    Game.prototype.createRooms = function () {
        ...
        var dinnertable1 = new Room(" sitting at a dinner table in the back of the canteen. Feels like a key is taped under the bench.");
        ...
        var courtyard1 = new Room(" outside in the courtyard. That bench looks interesting");
        var picknicktable1 = new Room(" sitting on the bench in the courtyard. A paper sticks out under the wooden table.");
        var freedom = new Room(" now free and escaped from the prison!");
        ...
        canteen2.setExits(canteen1, null, dinnertable1, null);
        dinnertable1.setExits(canteen2, null, null, null);
        ...
        courtyard1.setExits(null, null, picknicktable1, hall7);
        picknicktable1.setExits(courtyard1, null, null, null);
